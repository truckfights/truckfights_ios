...
struct  Socket_t941  : public Object_t
{
	...
	Thread_t932 * ___blocking_thread_13;
	...
	EndPoint_t1054 * ___seed_endpoint_20;
};
struct Socket_t941_StaticFields{
