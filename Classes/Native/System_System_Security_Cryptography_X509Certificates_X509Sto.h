...
struct  X509Store_t1112  : public Object_t
{
	...
	X509Certificate2Collection_t1103 * ___list_2;
	...
	X509Store_t1126 * ___store_4;
};
struct X509Store_t1112_StaticFields{
	...
	Dictionary_2_t73 * ___U3CU3Ef__switchU24mapF_5;
};
