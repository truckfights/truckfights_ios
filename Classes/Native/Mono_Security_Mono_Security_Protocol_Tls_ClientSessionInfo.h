...
struct  ClientSessionInfo_t1328  : public Object_t
{
	...
	ByteU5BU5D_t21* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t21* ___masterSecret_5;
};
struct ClientSessionInfo_t1328_StaticFields{
