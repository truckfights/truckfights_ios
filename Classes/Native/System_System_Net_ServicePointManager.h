...
struct  ServicePointManager_t1081  : public Object_t
{
};
struct ServicePointManager_t1081_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1024 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1068 * ___server_cert_cb_9;
};
