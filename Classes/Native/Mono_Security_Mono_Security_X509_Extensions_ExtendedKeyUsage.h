...
struct  ExtendedKeyUsageExtension_t1306  : public X509Extension_t1215
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1036 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1306_StaticFields{
	...
	Dictionary_2_t73 * ___U3CU3Ef__switchU24map14_4;
};
