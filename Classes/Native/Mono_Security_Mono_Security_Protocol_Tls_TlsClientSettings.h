...
struct RSAManaged_t1231;

#include "mscorlib_System_Object.h"

// Mono.Security.Protocol.Tls.TlsClientSettings
struct  TlsClientSettings_t1332  : public Object_t
{
	...
	X509CertificateCollection_t1074 * ___certificates_1;
	...
	RSAManaged_t1231 * ___certificateRSA_3;
};
